...
package types_pkg is
    ...
    -- =========================================================================
    -- INSTRUCTION UNPACKED RECORDS (R, I, S, U formats)
    -- =========================================================================

    -- R-type: rd | funct3 | rs1 | rs2 | funct7
    type r_type_t is record
        rd     : reg_addr_t;
        funct3 : funct3_t;
        rs1    : reg_addr_t;
        rs2    : reg_addr_t;
    ...
    -- I-type: rd | funct3 | rs1 | imm[11:0]
    type i_type_t is record
        rd     : reg_addr_t;
        funct3 : funct3_t;
        rs1    : reg_addr_t;
        imm    : data_word_t; -- sign-extended immediate
    end record;

    -- S-type: imm[11:5] (funct7) | rs2 | rs1 | funct3 | imm[4:0]
    type s_type_t is record
        funct3 : funct3_t;
        rs1    : reg_addr_t;
        rs2    : reg_addr_t;
        imm    : data_word_t; -- sign-extended immediate assembled from fields
    end record;

    -- U-type: rd | imm[31:12]
    type u_type_t is record
        rd     : reg_addr_t;
        imm    : data_word_t; -- upper immediate (bits 31:12 shifted)
    end record;
    ...
    constant ALI_OP    : std_logic_vector(6 downto 0) := "0010011"; -- ADDI, SLTI, etc.
    constant ALR_OP    : std_logic_vector(6 downto 0) := "0110011"; -- ADD, SUB, etc.
